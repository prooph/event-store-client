...
class overriden_system_stream_security extends AuthenticationTestCase
{
    ...
    /** @test */
    public function operations_on_system_stream_succeed_for_authorized_user(): Generator
    {
    ...
    /** @test */
    public function operations_on_system_stream_fail_for_not_authorized_user(): Generator
    {
