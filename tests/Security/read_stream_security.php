...
class read_stream_security extends AuthenticationTestCase
{
    ...
    public function reading_stream_with_no_credentials_is_denied(): void
    {
        wait(call(function () {
            yield $this->expectExceptionFromCallback(AccessDenied::class, function () {
                return $this->readEvent('read-stream', null, null);
            });
            yield $this->expectExceptionFromCallback(AccessDenied::class, function () {
                return $this->readStreamForward('read-stream', null, null);
            });
            yield $this->expectExceptionFromCallback(AccessDenied::class, function () {
                return $this->readStreamBackward('read-stream', null, null);
            });
        }));
    }
    ...
    public function reading_no_acl_stream_is_not_authenticated_when_not_existing_credentials_are_passed(): void
    {
        wait(call(function () {
            yield $this->expectExceptionFromCallback(NotAuthenticated::class, function () {
                return $this->readEvent('noacl-stream', 'badlogin', 'badpass');
            });
            yield $this->expectExceptionFromCallback(NotAuthenticated::class, function () {
                return $this->readStreamForward('noacl-stream', 'badlogin', 'badpass');
            });
            yield $this->expectExceptionFromCallback(NotAuthenticated::class, function () {
                return $this->readStreamBackward('noacl-stream', 'badlogin', 'badpass');
            });
        }));
    }
    ...
    public function reading_all_access_normal_stream_is_not_authenticated_when_not_existing_credentials_are_passed(): void
    {
        wait(call(function () {
            yield $this->expectExceptionFromCallback(NotAuthenticated::class, function () {
                return $this->readEvent('normal-all', 'badlogin', 'badpass');
            });
            yield $this->expectExceptionFromCallback(NotAuthenticated::class, function () {
                return $this->readStreamForward('normal-all', 'badlogin', 'badpass');
            });
            yield $this->expectExceptionFromCallback(NotAuthenticated::class, function () {
                return $this->readStreamBackward('normal-all', 'badlogin', 'badpass');
            });
        }));
    }
