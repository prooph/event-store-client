...
class subscribe_to_stream_security extends AuthenticationTestCase
{
    ...
    public function reading_stream_with_authorized_user_credentials_succeeds(): Generator
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('read-stream', 'user1', 'pa$$1'))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('read-stream', 'adm', 'admpa$$'))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('noacl-stream', null, null))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('noacl-stream', 'user1', 'pa$$1'))->unsubscribe();
            (yield $this->subscribeToStream('noacl-stream', 'user2', 'pa$$2'))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('noacl-stream', 'adm', 'admpa$$'))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('normal-all', null, null))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('normal-all', 'user1', 'pa$$1'))->unsubscribe();
            (yield $this->subscribeToStream('normal-all', 'user2', 'pa$$2'))->unsubscribe();
        }));
    }
    ...
    {
        yield $this->expectNoExceptionFromCallback(fn () => call(function (): Generator {
            (yield $this->subscribeToStream('normal-all', 'adm', 'admpa$$'))->unsubscribe();
        }));
    }
}
