...
class subscribe_to_stream_security extends AuthenticationTestCase
{
    ...
    {
        wait(call(function () {
            yield $this->subscribeToStream('read-stream', 'user1', 'pa$$1');
        }));
    }
    ...
    {
        wait(call(function () {
            yield $this->subscribeToStream('read-stream', 'adm', 'admpa$$');
        }));
    }
    ...
    {
        wait(call(function () {
            yield $this->subscribeToStream('noacl-stream', null, null);
        }));
    }
    ...
    {
        wait(call(function () {
            yield $this->subscribeToStream('noacl-stream', 'adm', 'admpa$$');
        }));
    }
    ...
    {
        wait(call(function () {
            yield $this->subscribeToStream('normal-all', null, null);
        }));
    }
    ...
    {
        wait(call(function () {
            yield $this->subscribeToStream('normal-all', 'adm', 'admpa$$');
        }));
    }
}
