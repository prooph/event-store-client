...
/**
 * Generated from protobuf message <code>Prooph.EventStoreClient.Messages.ClientMessages.UpdatePersistentSubscriptionCompleted</code>
 */
class UpdatePersistentSubscriptionCompleted extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Prooph\EventStoreClient\Messages\ClientMessages\UpdatePersistentSubscriptionCompleted_UpdatePersistentSubscriptionResult::class);
        $this->result = $var;
